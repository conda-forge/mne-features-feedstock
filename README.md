...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mne-features-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15562&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mne-features-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mne-features` can be installed with:

```
conda install mne-features
```

It is possible to list all of the versions of `mne-features` available on your platform with:
